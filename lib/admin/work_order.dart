...
import 'package:vineburgapp/admin/scan_tool.dart';
import 'package:vineburgapp/admin/scan_tool_workOrder.dart';
import 'package:vineburgapp/admin/work_order_inspect.dart';
                                ...
                                onSelected: (String value) {
                                  ...
                                  if (value == "Add Tool") {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => AdminScanToolWorkOrderPage(workId: data),
                                      ),
                                    );
                                  }
