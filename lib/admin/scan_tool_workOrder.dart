                ...
                child: ElevatedButton(
                  onPressed: () async {
                    Tool newTool = Tool(
                      ...
                      personCheckedTool: await getUserFullName(),
                      whereBeingUsed: machineNumber,
                      calibrationDate: '1/1/2024',
                    );
                      await newTool.addToolToUserAndWorkOrder(newTool, widget.workId);
                      Navigator.pop(context);
                      //await newTool.addToolToUserAndWorkOrder(newTool, widget.workOrder.id);
                    },
